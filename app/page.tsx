...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f1ee] text-[#171412] relative bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="mt-5 text-lg max-w-2xl mx-auto lg:mx-0 text-white">
                Agentes de IA, integrações e automações sob medida para escalar seu atendimento, vendas e operação —
                24/7.
              </p>
          ...
          */}
          <style jsx global>{`
            ...
            .chat-bubble {
              ...
              opacity: 0;
              animation: bubble-in 520ms cubic-bezier(0.2, 0.8, 0.2, 1) forwards, subtle-float 4s ease-in-out 600ms infinite;
        ...
        <div className="max-w-5xl mx-auto">
          <Card className="backdrop-blur-xl bg-white/60 border-white/40 shadow-2xl rounded-3xl">
            <CardContent className="p-8">
              <h2 className="text-3xl font-bold text-[#003c78] mb-4">
              ...
              <p className="mt-4 text-[#003c78] font-semibold">{""}</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="py-6 px-4 sm:px-6 lg:px-8 pt-20 pb-20">
      ...
      {/* Como Funciona na Prática (novo bloco) */}
      <ComoFuncionaSection />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card key={idx} className="bg-white/70 border-white/40 hover:shadow-lg transition-all duration-300 rounded-2xl">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white pb-20 lg:pl-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-[#003c78] mb-8 text-center">O que Entregamos</h2>
                ...
                <div key={i} className="flex items-center">
                  <Card className="bg-white/70 border-white/40 rounded-xl hover:shadow-md transition">
                    <CardContent className="px-4 py-3 flex items-center gap-2">
                      ...
                      <span className="leading-7 tracking-normal font-semibold text-lg">{step.title}</span>
                    </CardContent>
                  </Card>
            ...
            {[
              ...
              <Card key={idx} className="bg-white/70 border-white/40 rounded-2xl hover:shadow-xl transition">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl font-extrabold tracking-tight" style={{ color: kpi.color }} aria-label={kpi.value}>
                    {kpi.value}
                  </div>

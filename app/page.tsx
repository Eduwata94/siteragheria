...
return (
<div className="min-h-screen bg-[#f3f1ee] text-[#171412] relative">
{/* Navbar */}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      ...
      <div className="text-center lg:text-left">
        ...
        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 mb-6">
          <span className="px-3 py-1 rounded-full text-xs font-medium bg-white/10 border border-white/15 backdrop-blur shadow-xl text-[rgba(116,128,206,1)]">
            Consultoria de IA
          </span>
          <span className="px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-[#7c3aed]/30 to-[#22d3ee]/30 border border-white/15 backdrop-blur text-[rgba(56,73,181,1)]">
        ...
        <p className="mt-5 text-lg max-w-2xl mx-auto lg:mx-0 text-[rgba(116,128,206,1)]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mt-8">
          ...
          <Link href="#solucoes" className="hover:text-white underline underline-offset-4 text-[rgba(112,128,206,1)]">
            Ver soluções
          </Link>
        </div>
      </div>
    ...
    <div className="max-w-5xl mx-auto">
      <Card className="backdrop-blur-xl bg-white/60 border-white/40 shadow-2xl rounded-3xl">
        <CardContent className="p-8">
          <h2 className="text-3xl font-bold text-[#003c78] mb-4">Quem Somos</h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            {"Somos uma consultoria especializada em aplicar IA de forma estratégica e mensurável. Nada de soluções genéricas. Aqui, cada processo é mapeado, automatizado e otimizado com inteligência real."}
          </p>
          <p className="mt-4 text-[#003c78] font-semibold">
            {"A IA não substitui seu time — ela potencializa."}
          </p>
        </CardContent>
      </Card>
    </div>
...
{/* Visão / Missão / Diferencial */}
<section className="py-6 px-4 sm:px-6 lg:px-8">
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
    <Card className="hover:shadow-xl transition-all duration-300 bg-white/70 border-white/40 rounded-2xl">
      <CardContent className="p-6 flex items-start gap-4">
        <BadgeCheck className="h-8 w-8 text-[#f49f0a] shrink-0" />
        <div>
          <h3 className="text-xl font-semibold text-[#003c78]">Diferencial</h3>
          <p className="text-gray-700 mt-1">
            {"Criamos agentes de IA sob medida, conectados à realidade e operação da sua empresa."}
          </p>
        </div>
      </CardContent>
    </Card>
    ...
    <Card className="hover:shadow-xl transition-all duration-300 bg-white/70 border-white/40 rounded-2xl">
      <CardContent className="p-6 flex items-start gap-4">
        <Target className="h-8 w-8 text-[#4da6ff] shrink-0" />
        <div>
          <h3 className="text-xl font-semibold text-[#003c78]">Visão</h3>
          <p className="text-gray-700 mt-1">
            {"Ser a principal consultoria de IA para crescimento empresarial sustentável."}
          </p>
        </div>
      </CardContent>
    </Card>
    ...
    <Card className="hover:shadow-xl transition-all duration-300 bg-white/70 border-white/40 rounded-2xl">
      <CardContent className="p-6 flex items-start gap-4">
        <Brain className="h-8 w-8 text-[#003c78] shrink-0" />
        <div>
          <h3 className="text-xl font-semibold text-[#003c78]">Missão</h3>
          <p className="text-gray-700 mt-1">
            {"Transformar negócios automatizando o que limita e escalando o que importa."}
          </p>
        </div>
      </CardContent>
    </Card>
...
{/* O Novo Cenário */}
<section className="py-12 px-4 sm:px-6 lg:px-8 bg-transparent opacity-100">
  <div className="max-w-5xl mx-auto">
    <Card className="bg-white/70 border-white/40 rounded-2xl">
      <CardContent className="p-8">
        <blockquote className="text-2xl sm:text-3xl font-semibold text-[#003c78] leading-relaxed">
          {"Escalar não é vender mais. É não deixar o crescimento travar por dentro."}
        </blockquote>
...
{/* Dores que Atendemos */}
  <section className="relative py-12 px-4 sm:px-6 lg:px-8 overflow-hidden opacity-95 bg-transparent">
    ...
    <div className="max-w-6xl mx-auto">
      <h2 className="text-3xl font-bold text-[#003c78] mb-8">Dores que Atendemos</h2>
...
{/* O que Entregamos (Esteira) */}
<section className="py-12 px-4 sm:px-6 lg:px-8">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-3xl font-bold text-[#003c78] mb-8">O que Entregamos</h2>
    <div className="overflow-x-auto">
      <div className="min-w-[700px] grid grid-cols-5 gap-4">
        {[
          { title: "Mapeamento", icon: <Gauge className="h-5 w-5" />, color: "#4da6ff" },
          { title: "Criação de IA", icon: <Brain className="h-5 w-5" />, color: "#003c78" },
          { title: "Integração", icon: <Link2 className="h-5 w-5" />, color: "#f49f0a" },
          { title: "Diagnóstico", icon: <CheckCircle className="h-5 w-5" />, color: "#4da6ff" },
          { title: "Monitoramento", icon: <LineChart className="h-5 w-5" />, color: "#003c78" },
        ].map((step, i) => (
          <div key={i} className="flex items-center">
            <Card className="bg-white/70 border-white/40 rounded-xl hover:shadow-md transition">
              <CardContent className="px-4 py-3 flex items-center gap-2">
                <span className="inline-flex items-center justify-center rounded-md" style={{ color: step.color }}>
                  {step.icon}
                </span>
                <span className="font-medium text-gray-800">{step.title}</span>
              </CardContent>
            </Card>
            {i < 4 && <ArrowRight className="mx-2 h-5 w-5 text-gray-500" />}
          </div>
        ))}
      </div>
    </div>
...
<section id="solucoes" className="py-12 px-4 sm:px-6 lg:px-8">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-3xl font-bold text-[#003c78] mb-8">Soluções</h2>
